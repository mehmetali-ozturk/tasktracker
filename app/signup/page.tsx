...
export default function Signup() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      // This is where you would normally make an API call to create an account
        ...
        <div className="w-full max-w-md">
          <div className="backdrop-blur-lg bg-white/5 p-8 rounded-xl shadow-lg border border-white/10">
            ...
            <div className="mt-8 text-center text-sm text-gray-400">
              ...
              <Link href="/login" className="ml-1 font-medium text-purple-400 hover:text-purple-300">
                Sign in instead
              </Link>
            </div>
            ...
            <div className="mt-8">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-black/20 backdrop-blur-sm text-gray-400 rounded">Or sign up with</span>
                </div>
              </div>
